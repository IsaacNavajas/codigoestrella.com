      ...
      <React.Fragment>
        ...
        <p ><strong>script src="https://cdn.jsdelivr.net/npm/vue@2.5.16/dist/vue.js":</strong> CDN para instalar Vue.js.</p>
          ...
          <hr></hr><br/>
            ...
            <p>Etiqueta <strong>Style scoped</strong>: Para crear estilos que unicamente tengan un alcanze unicamente para el template del componente al que estamos trabajando. </p>
            
            <p><strong>script:</strong> dentro del script meteremos los <strong>import</strong> y el export default. Al crear el import Vue nos da un atajo que es la letra reservada @ que nos lleba directamente al src <u className="subrayado">import Example from <strong>"@/Example.png"</strong></u></p>
          ...
          <div className="col-12">
            ...
            <p><strong>this.$set(object, propertyName, value):</strong> para evitar problemas de reactividad en tareas asincronas, por ejemplo en una peticion fetch si encapsulamos un a con un metodo del fetch va a fallar . vm.$set() es un alias del global Vue.set()</p>
