...
class htmlyCss extends React.Component{
  ...
  <a href="hola">hey</a>
                    ...
                    <p><strong>nav:</strong> Sirve para poner los enlaces de navegacion de dentro de la piga o fuera como menus...</p>
                    <p><strong>article:</strong> Sirve para un solo uso o ser reusada como articulo, una entrada, un blog, un widget ...</p>
                    <p><strong>aside:</strong> Sirve para contener informacion indispuesta a la pagina como un biografia, publicidad, cosas relaccionadas...</p>
                    <p><strong>section:</strong> Sirve para elegir una seccion de un elemento, por ejemplo el despliegue de un navegador en varios niveles.</p>
                    <p><strong>hgroup:</strong> Sirve para concatenar titulos secundarios sin perjudicar el documento, se engloba siempre dentro de loss h1, h2, h3, h4, h5, h6.</p>
                    <p><strong>figure y figcaption:</strong> Sirve para colocar imagenes de forma profesional.</p>
                    <p><strong>div:</strong> Sirve para seleccionar una division.</p>
                    ...
                    <p><strong>h1:</strong> La etiqueta h1 es para poner un titulo, es una buena practica para SEO que en toda la pagina solo haya un solo h1.</p>
                    <p><strong>h2:</strong> Es como la etiqueta h1 pero cambia su estado de jerarquia y de tamaño, hay varios estados en la jerarquia de los titulos; h1, h2, h3. h4, h5, h6.</p>
                    <p><strong>p:</strong> Para escribir parrafos.</p>
                    ...
                    <p><strong>adress:</strong> Para escribir informacion de contactom, se suele escribir dentro del footer.</p>
  
                    <p><strong>div:</strong> Para crear decciones.</p>
                    <p><strong>span:</strong> Para marcar aislamientos de texto y darles estilos.</p>
                    <p><strong>iframe:</strong> Para crear otro contenedor de navegacion para incrustar otro html dentro de tu pagina. Puede tener los parametros src, height, width, scrolling, frameborder y seamless</p>
                    <p><strong>meta:</strong> Los meta van en el head y definien la parte invisible de la pagina pero de utilidad para la busqueda y definicion de la pagina.</p>
                    ...
                    <p><strong>a href="mailto:ejemplo@gmail.com":</strong> El atributo mailto: lo utilizamos cuando queremos desglosar automaticamente por un modal el email.</p>
                    <p><strong>a target="/otro":</strong> El atributo target lo utilizamos cuando queremos abrir una pestaña nueva con la direccion que le enviemos.</p>
                    ...
                    <p><strong>figure:</strong> Para introducir imagenes independientes.</p>
                    ...
                    <p><strong>form:</strong> Para empezar a crear un formulario puede tener varios atributos; action para definir donde queremos enviar el metodo del formulario, method par definir los metodos http del formulario y enctype multipart/form-data para subir archivos al servidor.</p>
                    <p><strong>input:</strong> Para crear controladores, puden tener atributos type y estos pueden ser password, text, submit, button... Pueden tener varios atributos como maxlength, value, name, .</p>
                    <p><strong>textarea:</strong> Para empezar a crear una lista no numerada.</p>
                    <p><strong>radio:</strong> es un tipo de input con el parametro type radio, puede tener el parametro checked para definir por defecto al que queramos ponerle ese parametro, suelen ir cada uno con un label. Los radio por defecto solo se puede seleccionar uno</p>
                    ...
                    <p><strong>leyend:</strong> Para crear un titulo a un grupo asociado con fieldest, vandentro de la etiqueta fieldset.</p>
                    <br/>
          ...
          <div className="col-5  textoderecho ">
                    ...
                    <br/>
                    <hr></hr><br/>
                    <h2  className="bigtitle">Metodos</h2>
                    <br/>
                    ...
                    <p><strong>background-repeat:</strong> Para definir la repeticion de la imagen.</p>
                    <p><strong>background-position:</strong> Para definir la posicion de la imagen.</p>
                    <p><strong>opacity: 0.5:</strong> Para definir la opacidad.</p>
                    <p><strong>display:</strong> Para definir el nodo en el que se muestra un elemento, imagen o texto sus parametros pueden ser none, block, inline,table...</p>
                    ...
                    <p><strong>text-decoration:</strong> Para definir la decoracion del texto.</p>
                    ...
                    <p><strong>vertical-align:</strong> Para definir la alineacion vertical del texto; middle, bottom, sub...</p>
                    <p><strong>z-index:</strong> Para definir la posicion de un elemento o imagen en eje z.</p>
                    <p><strong>position:</strong> Para definir la posicion del elemento, sus atributos son; static, relative, fixed, absolute, sticky.</p>
                    <p><strong>marggin:</strong> Para definir el margen.</p>
                    <p><strong>justify-content:</strong> Para definir la alineacion de todos los elementos en el eje principal.</p>
                    <p><strong>align-items:</strong> Para definir la alineacion de todos los elementos en el eje transversal.</p>
                    <p><strong>align-self:</strong> Controla la alineacion de un elemento flexible en el eje transversal.</p>
                    ...
                    <p><strong>float:</strong> Para definir ele flujo de posicion.</p>
                    ...
                    <p><strong>position:static:</strong> Para definir la posicion por defecto.</p>
                    <p><strong>position:relative:</strong> Para definir la posicion por defecto, su posicion no repercute en la posicion del elemento consiguiente pero si conserva su espacio como si fuese position:static.</p>
                    <p><strong>position:absolute:</strong> Para definir la posicion por defecto, su posicion no repercute en la posicion del elemento consiguiente y no conserva su espacio como si fuese position:static.</p>
                    <p><strong>position:fixed:</strong> Para definir la posicion por defecto y sin crear espacios entre el elemento consiguiente, su funcion es como un bloque contendor.</p>
