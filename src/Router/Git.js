    ...
    return (
      ...
      <React.Fragment>
        <div className="container">
          ...
          <h2  className="bigtitle font">Comandos de consola basicos</h2><br/>
   

          <p><strong>ls: </strong>para hacer una raiz de los elementos que tenermos. podemos usar ls -lha como parametros.</p>
          <p><strong>cd:</strong> para entrar entre carpetajes.[ . / define la carpeta actual, . . / va una carpeta atras.].</p>
          ...
          <p><strong>code:</strong> para abrir el archivo con nuestro editor de codigo.</p>
          <p><strong>vi:</strong> nos muestra el editor de codigo.</p>
          ...
          <p><strong>git add . :</strong> agrega el archivo al entorno de memoria staging. con git add . agregamos todos los archivos. tambien podemos agregar un solo archivo; git add index.html</p>
          ...
          <p><strong>git push:</strong> envia el archivo a un repositorio remoto.</p>
          ...
          <p><strong>git rm --cached:</strong> elimina archivos del commit y del area de staging pero los mantiene el disco duro.</p>
          ...
          <p><strong>git checkout:</strong> para cambiar entre ramas, tambien podemos usarlo para ir a otro estado de memoria de git show para ver ese commit y volver despues al master. tambien podemos volver a otro commit, trackearlo, hacer otro commit para guardar un commit anterior como nuevo, sin tener que borrar los commits anteriores.</p>
          <br/>
          <hr></hr><br/>
          <h2  className="bigtitle">GitHub</h2><br/>


          <p><strong>npm install: </strong>cuando clonas un proyecto de github hay que volver a descargar las dependencias para que funcione la aplicacion correctamente.</p>
          ...
          <p><strong>git pull origin master:</strong> para traer los datos de github al ordenador, es una buena practica primero hacer un git pull y despues un git push.</p>
          <p><strong>git push origin master: </strong>envia la rama master al origen remoto del repositorio.</p>
          <p><strong>git push origin master --allow-unrelated-histories: </strong>la primera vez que hagamos un push a nuestro repositorio tenemos que enviar el --allow-unrelated-histories, nos entra en vi, para salir y guardar pulsamos esc+sift+z+z, despues de hacer esto volvemos a hacer un git push origin master normal.</p>
          ...
          <p><strong>Git tag -d "NOMBRE_DEL_TAG" / Git push origin :refs/tags"NOMBRE_DEL_TAG":</strong> borra un tag del repositorio, primero Git tag -d "NOMBRE_DEL_TAG" y despues Git push origin :refs/tags"NOMBRE_DEL_TAG".</p>
          <p><strong>git clone "PEGAR_URL_DEL_REPOSITORIO":</strong> cuando queremos clonar un repositorio. e suele utilizar cuando no tenemos permisos del proyecto en github</p>
          ...
          <p><strong>git stash list:</strong> nos enceña nuestros stash.</p>
          ...
          <p><strong>git commit --amend: </strong>para traernos lo que estabamos haciendo a nuestro commit anterior. esto es una buena practica ya que n tenemos porque hacer otro commit nuevo.</p>
          ...
          <p><strong>git grep -n gato:</strong> aparecera un output diciendonos en que linea esta la palabra gato.</p>
          <p><strong>git grep -c gato: </strong>aparecera un output diciendonos cuantas veces se repitela palabra gato.</p>
          <br/>
          <br/>
          <br/>
          <br/>
