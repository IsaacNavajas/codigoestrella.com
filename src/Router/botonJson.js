                  ...
                  <Modal
                      ...
                      >
                        ...
                        <div  className="bigtitle font">Json</div><br/>
                          ...
                          <p>Cuando se crea el Json hay que pensar como va a quedar finalmente el proyecto, donde queremos desplegar cada elemento del json, si queremos desplegar todos los elementos en una sola petición usaremeos un array, pero si lo que queremos es desplegar varios títulos en distintas lineas de tiempo en el código usaremos las llaves, dividiremos todos los datos en sus padres como se muestra en el ejemplo.</p> <br/>
